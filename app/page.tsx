          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid items-center gap-12 lg:grid-cols-2">
              ...
              <div className="space-y-8">
                ...
                <Badge
                  variant="secondary"
                  className="w-fit border border-blue-200 bg-blue-50 text-blue-700 shadow-sm hover:bg-blue-100 dark:border-blue-800 dark:bg-blue-950/50 dark:text-blue-300 dark:hover:bg-blue-900/50"
                >
              ...
              <div className="relative">
                ...
                <Card className="relative overflow-hidden border border-gray-200 bg-white/90 p-6 shadow-xl backdrop-blur-sm dark:border-gray-700 dark:bg-gray-800/90 dark:shadow-2xl">
                  ...
                  <div className="mb-6 flex items-center justify-between">
                    ...
                    <Badge
                      variant="secondary"
                      className="border border-green-200 bg-green-50 text-green-700 dark:border-green-800 dark:bg-green-950/50 dark:text-green-300"
                    >
