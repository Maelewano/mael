          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid items-center gap-12 lg:grid-cols-2">
              ...
              <div className="space-y-8">
                ...
                <Badge
                  variant="secondary"
                  className="w-fit border border-blue-200 bg-blue-50 text-blue-700 shadow-sm hover:bg-blue-100"
                >
                ...
                <div className="space-y-4">
                  ...
                  <p className="mb-6 max-w-2xl font-semibold text-gray-700 md:text-lg lg:mb-8 lg:text-xl">
            ...
            <div className="relative">
              ...
              <Card className="relative overflow-hidden border border-gray-200 bg-white/90 p-6 shadow-xl backdrop-blur-sm">
                ...
                {/* Action Button */}
                <Button
                  className="mt-6 w-full border-0 bg-gradient-to-r from-indigo-600 to-indigo-700 px-8 py-4 text-lg font-semibold text-white shadow-lg transition-all duration-200 hover:from-indigo-700 hover:to-indigo-800 hover:shadow-xl disabled:from-gray-400 disabled:to-gray-500"
